	...
	<div class="card card-outline card-primary">
        ...
        <div class="row">
          <div class="col-md-6">
              ...
              <div class="form-group">
                <label for="" class="control-label">Numero P.O</label>
                <input type="text" name="Ponumber" id="" class="form-control form-control-sm" value="<?php echo isset($Ponumber) ? $$Ponumber : '' ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Date d'arrivée</label>
                <input type="date" name="sender_address" id="" class="form-control form-control-sm" value="<?php echo isset($sender_address) ? $sender_address : '' ?>" required>
              </div>
              <div class="form-group">
                <label for="" class="control-label">Date de livraison</label>
                <input type="date" name="sender_contact" id="" class="form-control form-control-sm" value="<?php echo isset($sender_contact) ? $sender_contact : '' ?>" required>
              </div>
          </div>
          <div class="col-md-6">
              <b>Autres Informations</b>
              <div class="form-group">
                <label for="" class="control-label">Numero de Licence</label>
              ...
              <div class="form-group">
                <label for="" class="control-label">Numero BL</label>
              ...
              <div class="form-group">
                <label for="" class="control-label">Numero Feri</label>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="checkbox" name="type" id="dtype" <?php echo isset($type) && $type == 1 ? 'checked' : '' ?> data-bootstrap-switch data-toggle="toggle" data-on="Aerien" data-off="Maritime" class="switch-toggle status_chk" data-size="xs" data-offstyle="info" data-width="5rem" value="1">
          ...
          <div class="col-md-6" id=""  <?php echo isset($type) && $type == 1 ? 'style="display: none"' : '' ?>>
            <?php if($_SESSION['login_branch_id'] <= 0): ?>
              <div class="form-group" id="fbi-field">
                <label for="" class="control-label">Transitaire en Charge</label>
        ...
        <div class="row">
          <div class="col-md-12 d-flex justify-content-end">
            <button  class="btn btn-sm btn-primary bg-gradient-primary" type="button" id="new_parcel"><i class="fa-sharp fa-solid fa-rectangle-history-circle-plus"> </i> Ajouter</button>
          </div>
        </div>
              <?php endif; ?>
      </form>
  	...
  	<div class="card-footer border-top border-info">
  		<div class="d-flex w-100 justify-content-center align-items-center">
  			<button class="btn btn-flat  bg-gradient-primary mx-2" form="manage-parcel">Enregistrer</button>
