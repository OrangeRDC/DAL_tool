			...
			<form action="" id="manage_user">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<b class="text-muted">Information Personelle</b>
						...
						<div class="form-group">
							<label for="" class="control-label">Post-nom</label>
					...
					<div class="col-md-6">
						...
						<b class="text-muted">Accreditation au systeme</b>
						<?php if($_SESSION['login_type'] == 1): ?>
						<div class="form-group">
							<label for="" class="control-label">Role de l'utilisateur</label>
							<select name="type" id="type" class="custom-select custom-select-sm">
								<option value="2" <?php echo isset($type) && $type == 2 ? 'selected' : '' ?>>enregisteur</option>
