...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-body">
			...
			<?php 
			$status_arr = array("Attendus","En cours","Livré"); ?>
				...
				<label for="date_from" class="mx-1">Du</label>
                ...
                <label for="date_to" class="mx-1">Au</label>
                ...
                <button class="btn btn-sm btn-primary mx-1 bg-gradient-primary" type="button" id='view_report'>Voir le rapport</button>
			</div>
		</div>
	</div>
	<?php $status = isset($_GET['status']) ? $_GET['status'] : 'all' ?>
	...
	<div class="card card-outline card-primary">
		<div class="card-body">
			<div class="d-flex w-100 px-1 py-2 justify-content-center align-items-center">
               ...
               <a href="statistique.php"> <button class="btn btn-sm btn-primary mx-1 bg-gradient-primary" type="button" id='view_report'>Statistique en Volume</button></a>
